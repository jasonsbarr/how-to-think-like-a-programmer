...
The comment for the above function signature uses a *docblock* to document the function. I'll explain what that means when we look at designing functions in chapter 10.
